<template>
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a @click="$router.replace('/msite')" class="back">
        <i class="iconfont icon-jiantouarrowhead7"/>
      </a>
    </nav>
    <div class="shop-content">
      <img src="https://fuss10.elemecdn.com/8/40/02872ce8aefe75c16d3190e75ad61jpeg.jpeg" class="content-image">
      <div class="header-content">
        <h2 @click="isShowIntro=true" class="content-title">
    ...
    <div class="shop-brief-modal" v-show="isShowIntro">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span @click="isShowIntro=false" class="iconfont icon-guanbi-yuanshijituantubiao"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show='isShowDiscount'>
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span @click="isShowDiscount=false" class="iconfont icon-guanbi-yuanshijituantubiao"></span>
        </div>
      </div>
